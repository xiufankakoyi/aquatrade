...
def main():
    ...
    print(f"{'🔍 扫描模式' if args.dry_run else '🔧 修复模式'}")
    ...
    if args.dry_run:
        print("\n💡 提示: 使用 --dry-run=false 或直接运行（不加 --dry-run）来实际移除日志")
