...
if df.is_empty():
    ...
    print(f"\n   000001 数据行数: {len(df_000001)}")
    if len(df_000001) > 0:
        print(f"   000001 日期范围: {df_000001['trade_date'].min()} ~ {df_000001['trade_date'].max()}")
        print(f"\n   000001 前3行:")
        print(df_000001.select(['trade_date', 'open', 'close', 'ma5', 'ma10']).head(3))
