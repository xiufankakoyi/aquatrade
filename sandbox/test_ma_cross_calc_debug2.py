...
class MACrossStrategyCalcDebug:
    ...
    def generate_signals_vectorized(
        ...
        print(f"[Signal] 总信号数: {signal_count}")
        
        return signals


print("=" * 70)
print("MA交叉策略回测 - 自己计算MA（调试版2）")
print("=" * 70)
...
try:
    ...
    print(f"\n[5] 每日总资产:")
    for dv in daily_values[-10:]:  # 显示最后10天
        print(f"   {dv['date']}: {dv['total_value']:.2f}")
